...
import static androidx.fluidviewpager2.widget.ViewPager2.ORIENTATION_HORIZONTAL;
...
import androidx.fluidviewpager2.widget.ViewPager2.OnPageChangeCallback;
 ...
 * for {@link androidx.fluidviewpager2.widget.ViewPager2}. As part of this process, it keeps track of the current scroll position
...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private final @NonNull androidx.fluidviewpager2.widget.ViewPager2 mViewPager;
    ...
    ScrollEventAdapter(@NonNull androidx.fluidviewpager2.widget.ViewPager2 viewPager) {
     ...
     * {@link androidx.fluidviewpager2.widget.ViewPager2#endFakeDrag()} is called.
     */
