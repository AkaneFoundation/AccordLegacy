...
package androidx.fluidviewpager2.widget;
...
import androidx.fluidrecyclerview.widget.PagerSnapHelper;
import androidx.fluidrecyclerview.widget.RecyclerView;
import androidx.fluidrecyclerview.widget.RecyclerView.Adapter;
import androidx.fluidrecyclerview.widget.RecyclerView.ItemDecoration;
import androidx.fluidviewpager2.adapter.FragmentStateAdapter;
import androidx.fluidviewpager2.adapter.StatefulAdapter;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private androidx.fluidviewpager2.widget.PageTransformerAdapter mPageTransformerAdapter;
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        mPageTransformerAdapter = new androidx.fluidviewpager2.widget.PageTransformerAdapter(mLayoutManager);
    ...
    void snapToPage() {
        ...
        if (snapDistance[0] != 0 || snapDistance[1] != 0) {
            mRecyclerView.smoothScrollBy(snapDistance[0], snapDistance[1], (Interpolator) interpolator);
        }
    }
